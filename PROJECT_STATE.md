...
5. Deploy backend + frontend của nhánh v1.9, rồi áp `20260927090200_v19_drop_legacy_columns.sql`; sau đó thực hiện đợt 2 theo plan `docs/superpowers/plans/2026-09-26-lesson-upload-db-only.md`.
