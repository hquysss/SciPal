...
4. Giai đoạn 3–5 của spec giao diện theo cấp học (luồng học → cá nhân → giáo viên/admin; bật `DARK_MODE_ENABLED` cuối giai đoạn 5). Ngoài phạm vi giao diện: quiz bài học thật (API ẩn đáp án, chấm server), nối thẻ thuật ngữ/tài liệu với dữ liệu thật, API AI Tutor.
