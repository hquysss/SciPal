...
export const SCENE_BASE: SceneObject[] = [
  {
    id: 'desk',
    parts: [{ shape: 'box', size: [24, 0.3, 16], offset: [0, -0.15, 0], color: 'line' }],
    position: [0, 0, 0],
    rotationY: 0,
    float: 0,
  },
  {
    ...
    parts: [
      ...
      { shape: 'box', size: [1.55, 0.06, 2.2], offset: [-0.79, 0.06, 0], rotation: [0, 0, 0.03], color: 'surface' },
      { shape: 'box', size: [1.55, 0.06, 2.2], offset: [0.79, 0.06, 0], rotation: [0, 0, -0.03], color: 'surface' },
      ...pageLines(-0.8),
      ...pageLines(0.8),
      { shape: 'cylinder', size: [0.22, 0.01, 0.22], offset: [0.95, 0.13, -0.55], segments: 10, color: 'action' },
    ],
    position: [0, 0, 0],
    rotationY: -0.12,
    float: 0,
...
export const SCENE_OBJECTS: Record<EducationLevel, SceneObject[]> = {
  ...
  lower_secondary: [
    ...
    },
    {
      id: 'set-square',
      parts: [
        { shape: 'cylinder', size: [0.9, 0.05, 0.9], offset: [0, 0, 0], segments: 3, color: 'action' },
        { shape: 'cylinder', size: [0.34, 0.056, 0.34], offset: [0, 0, 0], segments: 3, color: 'line' },
      ],
      position: [2.75, 0.04, -0.7],
      rotationY: 0.2,
      float: 0.04,
    },
    {
