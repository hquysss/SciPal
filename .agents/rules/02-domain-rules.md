...
- **Màu thương hiệu (Brand Color)**: `SCIPAL_GREEN` (`#16a34a`) chỉ dùng cho logo cỏ 4 lá. Nền navbar dùng token `nav` = màu chính của cấp học (Tiểu học nâu nhạt, THCS xanh dương, THPT xanh lá; chưa chọn cấp: `#15803D`).
